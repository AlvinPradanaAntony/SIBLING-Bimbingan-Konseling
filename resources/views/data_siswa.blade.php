                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <div style="display: flex; justify-content: center; align-items: center;">
                        <img id="output" style="width: 90px; height: 90px; object-fit: cover; border-radius: 50%;"/>
                      </div>
                      <div class="mb-3">
                        <label for="photo" class="col-form-label">Unggah Foto</label>
                        <input type="file" class="form-control" id="photo" name="photo" accept=".pdf,.jpg,.png" onchange="loadFile(event)">
                      </div>
                      <div class="mb-3">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form action="{{ route('student.import') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                          <a href="{{ route('student.download_format') }}" class="btn btn-sm btn-success">
                            ...
                            <tr style="font-size: 14px">
                                  ...
                                  <div class="modal-dialog">
                                    <div class="modal-content">
                                      ...
                                      <form action="{{ route('student.update', $student->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-body">
                                          <div style="display: flex; justify-content: center; align-items: center;">
                                            <img id="outputUpdate" src="{{ route('student.showImage', $student->id) }}" alt="Foto" style="width: 90px; height: 90px; object-fit: cover; border-radius: 50%; margin-bottom: 10px;">
                                          </div>
                                          <div class="mb-3">
                                            <label for="photo" class="col-form-label">Unggah Foto</label>
                                              @if ($student->photo)
                                                <div class="mb-2">
                                                  ...
                                                  @php
                                                      $fileType = finfo_buffer(finfo_open(FILEINFO_MIME_TYPE), $student->photo);
                                                  @endphp
                                                  @if (str_contains($fileType, 'image'))
                                                      <img src="{{ route('student.showImage', $student->id) }}" alt="Foto" style="max-width: 100px; max-height: 100px; margin-bottom: 10px;">
                                                  ...
                                                  @endif
                                                  <br>
                                                  <a href="{{ route('student.download', $student->id) }}" class="btn btn-sm btn-primary mt-2">Download Foto</a>
                                                </div>
                              ...
                              <td>
                                @if ($student->photo)
                                  ...
                                  @else
                                    <img src="{{ route('student.showImage', $student->id) }}" alt="Foto" style="width: 90px; height: 90px; object-fit: cover; border-radius: 50%; margin-bottom: 10px;">
                                  @endif
                                  <a href="{{ route('student.download', $student->id) }}" class="btn btn-primary btn-sm">
