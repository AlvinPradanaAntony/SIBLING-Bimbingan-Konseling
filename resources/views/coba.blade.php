...
<body>
  ...
  <div id="collapseEach">
    ...
    <div class="collapse" data-bs-parent="#collapseEach" id="collapseOne">
      <div class="card card-body">
        <strong>This is the first item's collapse body.</strong> It is hidden by default, until the collapse plugin adds the appropriate classes that we use to style each element. These classes control the overall appearance, as well as the showing and hiding via CSS transitions. You can modify any of this with custom CSS or overriding our default variables. It's also worth noting that just about any HTML can go within the <code>.card-body</code>, though the transition does limit overflow.
      </div>
    </div>
    ...
    <div class="collapse" data-bs-parent="#collapseEach"  id="collapseTwo">
      <div class="card card-body">
        <strong>This is the second item's collapse body.</strong> It is hidden by default, until the collapse plugin adds the appropriate classes that we use to style each element. These classes control the overall appearance, as well as the showing and hiding via CSS transitions. You can modify any of this with custom CSS or overriding our default variables. It's also worth noting that just about any HTML can go within the <code>.card-body</code>, though the transition does limit overflow.
      </div>
    </div>
    ...
    <div class="collapse" data-bs-parent="#collapseEach"  id="collapseThree">
      <div class="card card-body">
        <strong>This is the third item's collapse body.</strong> It is hidden by default, until the collapse plugin adds the appropriate classes that we use to style each element. These classes control the overall appearance, as well as the showing and hiding via CSS transitions. You can modify any of this with custom CSS or overriding our default variables. It's also worth noting that just about any HTML can go within the <code>.card-body</code>, though the transition does limit overflow.
      </div>
    </div>
  </div>
